        ...
        for ($row = 0; $row <= $highestrow; $row++) {
            if ($row >1) {
                ...
                if ($nrp != '') {
                    ...
                    $insertqry = "INSERT INTO mahasiswa(id_periode,nrp,nama_mhs,nilai_placement,placement_level,start_level,now_level,status_mhs) VALUES ('$periode','$nrp','$nama','$nilai','0','0','0','0')";
